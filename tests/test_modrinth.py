...
def test_find_profile_id_quilt(ws_tmp):
    game = ws_tmp / "mc"
    profile = game / "versions" / "quilt-loader-0.24.0-1.20.1"
    profile.mkdir(parents=True)
    assert find_profile_id(game, "quilt", "1.20.1") == "quilt-loader-0.24.0-1.20.1"
