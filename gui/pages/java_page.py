"""Java 页（#16）：托管运行时管理（删除）、检测列表、安装新 JRE。"""
...
class JavaPage(QWidget):
    def __init__(self) -> None:
        ...
        self.managed_table.horizontalHeader().setStretchLastSection(True)
        ...
        self.detected_table.horizontalHeader().setStretchLastSection(True)
    ...
    def refresh(self) -> None:
        ...
        # 探测 java -version 较慢：放到后台，避免启动/刷新时卡住界面
        run_in_background(
